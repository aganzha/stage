...
#[cfg(test)]
use crate::status_view::op::{LastOp, StageDiffs};
#[cfg(test)]
...
pub fn test_choose_cursor_position() {
    ...
    let iter =
        diffs.choose_cursor_position(&buffer, Some(DiffKind::Staged), &cell, CursorPosition::None);
